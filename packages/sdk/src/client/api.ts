...
export type CompiledModelTypeEnum =
   (typeof CompiledModelTypeEnum)[keyof typeof CompiledModelTypeEnum];
...
export type DatabaseTypeEnum =
   (typeof DatabaseTypeEnum)[keyof typeof DatabaseTypeEnum];
...
export type NotebookCellTypeEnum =
   (typeof NotebookCellTypeEnum)[keyof typeof NotebookCellTypeEnum];
...
export const ConnectionsApiAxiosParamCreator = function (
   ...
   return {
      ...
      getConnection: async (
         ...
         const localVarPath =
            `/projects/{projectName}/connections/{connectionName}`
               ...
               .replace(
                  `{${"connectionName"}}`,
                  encodeURIComponent(String(connectionName)),
               );
      ...
      listConnections: async (
         ...
         const localVarPath = `/projects/{projectName}/connections`.replace(
            `{${"projectName"}}`,
            encodeURIComponent(String(projectName)),
         );
         // use dummy base URL string because the URL constructor only accepts absolute URLs.
   ...
   return {
      ...
      > {
         const localVarAxiosArgs =
            await localVarAxiosParamCreator.getConnection(
               projectName,
               connectionName,
               options,
            );
         ...
         const localVarOperationServerBasePath =
            operationServerMap["ConnectionsApi.getConnection"]?.[
      ...
      async getQuerydata(
         ...
         (axios?: AxiosInstance, basePath?: string) => AxiosPromise<QueryData>
      > {
         const localVarAxiosArgs = await localVarAxiosParamCreator.getQuerydata(
            projectName,
            connectionName,
            sqlStatement,
            _options,
         ...
         const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         const localVarOperationServerBasePath =
            operationServerMap["ConnectionsApi.getQuerydata"]?.[
               localVarOperationServerIndex
            ]?.url;
         return (axios, basePath) =>
            createRequestFunction(
      ...
      async getSqlsource(
         ...
         (axios?: AxiosInstance, basePath?: string) => AxiosPromise<SqlSource>
      > {
         const localVarAxiosArgs = await localVarAxiosParamCreator.getSqlsource(
            projectName,
            connectionName,
            sqlStatement,
            options,
         ...
         const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         const localVarOperationServerBasePath =
            operationServerMap["ConnectionsApi.getSqlsource"]?.[
               localVarOperationServerIndex
            ]?.url;
         return (axios, basePath) =>
            createRequestFunction(
      ...
      async getTablesource(
         ...
         (axios?: AxiosInstance, basePath?: string) => AxiosPromise<TableSource>
      > {
         const localVarAxiosArgs =
            await localVarAxiosParamCreator.getTablesource(
               projectName,
               connectionName,
               tableKey,
               tablePath,
         ...
         const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         const localVarOperationServerBasePath =
            operationServerMap["ConnectionsApi.getTablesource"]?.[
               localVarOperationServerIndex
            ]?.url;
         return (axios, basePath) =>
            createRequestFunction(
      ...
      async getTemporarytable(
         ...
         (
            axios?: AxiosInstance,
            basePath?: string,
         ) => AxiosPromise<TemporaryTable>
      > {
         const localVarAxiosArgs =
            await localVarAxiosParamCreator.getTemporarytable(
               projectName,
               connectionName,
               sqlStatement,
               options,
         ...
         const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         const localVarOperationServerBasePath =
            operationServerMap["ConnectionsApi.getTemporarytable"]?.[
               localVarOperationServerIndex
            ]?.url;
         return (axios, basePath) =>
            createRequestFunction(
      ...
      > {
         ...
         const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         const localVarOperationServerBasePath =
            operationServerMap["ConnectionsApi.getTest"]?.[
               localVarOperationServerIndex
            ]?.url;
         return (axios, basePath) =>
            createRequestFunction(
      ...
      async listConnections(
         ...
         (
            axios?: AxiosInstance,
            basePath?: string,
         ) => AxiosPromise<Array<Connection>>
      > {
         const localVarAxiosArgs =
            await localVarAxiosParamCreator.listConnections(
               projectName,
               options,
            );
         const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
 ...
 * @export
 */
export const DatabasesApiAxiosParamCreator = function (
   configuration?: Configuration,
) {
   return {
      /**
...
export const DatabasesApiFp = function (configuration?: Configuration) {
   const localVarAxiosParamCreator =
      DatabasesApiAxiosParamCreator(configuration);
   return {
      /**
       *
       * @summary Returns a list of relative paths to the databases embedded in the package.
      ...
      async listDatabases(
         ...
         (
            axios?: AxiosInstance,
            basePath?: string,
         ) => AxiosPromise<Array<Database>>
      > {
         const localVarAxiosArgs =
            await localVarAxiosParamCreator.listDatabases(
               projectName,
               packageName,
               versionId,
               options,
         ...
         const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         const localVarOperationServerBasePath =
            operationServerMap["DatabasesApi.listDatabases"]?.[
               localVarOperationServerIndex
            ]?.url;
         return (axios, basePath) =>
            createRequestFunction(
 ...
 * @export
 */
export const DatabasesApiFactory = function (
   configuration?: Configuration,
   basePath?: string,
   axios?: AxiosInstance,
) {
...
export class DatabasesApi extends BaseAPI {
   ...
   public listDatabases(
      ...
      return DatabasesApiFp(this.configuration)
         .listDatabases(projectName, packageName, versionId, options)
         .then((request) => request(this.axios, this.basePath));
   }
}
...
export const ModelsApiFp = function (configuration?: Configuration) {
   ...
   return {
      ...
      > {
         ...
         const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         const localVarOperationServerBasePath =
            operationServerMap["ModelsApi.getModel"]?.[
               localVarOperationServerIndex
            ]?.url;
         return (axios, basePath) =>
            createRequestFunction(
      ...
      > {
         ...
         const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         const localVarOperationServerBasePath =
            operationServerMap["ModelsApi.listModels"]?.[
               localVarOperationServerIndex
            ]?.url;
         return (axios, basePath) =>
            createRequestFunction(
 ...
 * @export
 */
export const PackagesApiAxiosParamCreator = function (
   configuration?: Configuration,
) {
   return {
      /**
      ...
      listPackages: async (
         ...
         const localVarPath = `/projects/{projectName}/packages`.replace(
            `{${"projectName"}}`,
            encodeURIComponent(String(projectName)),
         );
         // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const PackagesApiFp = function (configuration?: Configuration) {
   const localVarAxiosParamCreator =
      PackagesApiAxiosParamCreator(configuration);
   return {
      /**
       *
       * @summary Returns the package metadata.
      ...
      > {
         ...
         const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         const localVarOperationServerBasePath =
            operationServerMap["PackagesApi.getPackage"]?.[
               localVarOperationServerIndex
            ]?.url;
         return (axios, basePath) =>
            createRequestFunction(
      ...
      > {
         ...
         const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         const localVarOperationServerBasePath =
            operationServerMap["PackagesApi.listPackages"]?.[
               localVarOperationServerIndex
            ]?.url;
         return (axios, basePath) =>
            createRequestFunction(
...
export const ProjectsApiAxiosParamCreator = function (
   ...
   return {
      ...
      getProject: async (
         ...
         const localVarPath = `/projects/{projectName}`.replace(
            `{${"projectName"}}`,
            encodeURIComponent(String(projectName)),
         );
         // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const ProjectsApiFp = function (configuration?: Configuration) {
   const localVarAxiosParamCreator =
      ProjectsApiAxiosParamCreator(configuration);
   return {
      /**
       *
       * @summary Returns metadata about the project.
      ...
      > {
         const localVarAxiosArgs =
            await localVarAxiosParamCreator.listProjects(options);
         const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         const localVarOperationServerBasePath =
            operationServerMap["ProjectsApi.listProjects"]?.[
               localVarOperationServerIndex
            ]?.url;
         return (axios, basePath) =>
            createRequestFunction(
 ...
 * @export
 */
export const QueryresultsApiAxiosParamCreator = function (
   configuration?: Configuration,
) {
   return {
      /**
...
export const QueryresultsApiFp = function (configuration?: Configuration) {
   const localVarAxiosParamCreator =
      QueryresultsApiAxiosParamCreator(configuration);
   return {
      /**
       *
       * @summary Returns a query and its results.
      ...
      async executeQuery(
         ...
         (axios?: AxiosInstance, basePath?: string) => AxiosPromise<QueryResult>
      > {
         const localVarAxiosArgs = await localVarAxiosParamCreator.executeQuery(
            projectName,
            packageName,
            path,
            query,
         ...
         const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         const localVarOperationServerBasePath =
            operationServerMap["QueryresultsApi.executeQuery"]?.[
               localVarOperationServerIndex
            ]?.url;
         return (axios, basePath) =>
            createRequestFunction(
 ...
 * @export
 */
export const QueryresultsApiFactory = function (
   configuration?: Configuration,
   basePath?: string,
   axios?: AxiosInstance,
) {
...
export class QueryresultsApi extends BaseAPI {
   ...
   public executeQuery(
      ...
      return QueryresultsApiFp(this.configuration)
         .executeQuery(
            projectName,
            packageName,
            path,
 ...
 * @export
 */
export const SchedulesApiAxiosParamCreator = function (
   configuration?: Configuration,
) {
   return {
      /**
...
export const SchedulesApiFp = function (configuration?: Configuration) {
   const localVarAxiosParamCreator =
      SchedulesApiAxiosParamCreator(configuration);
   return {
      /**
       *
       * @summary Returns a list of running schedules.
      ...
      > {
         const localVarAxiosArgs =
            await localVarAxiosParamCreator.listSchedules(
               projectName,
               packageName,
               versionId,
               options,
         ...
         const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         const localVarOperationServerBasePath =
            operationServerMap["SchedulesApi.listSchedules"]?.[
               localVarOperationServerIndex
            ]?.url;
         return (axios, basePath) =>
            createRequestFunction(
 ...
 * @export
 */
export const SchedulesApiFactory = function (
   configuration?: Configuration,
   basePath?: string,
   axios?: AxiosInstance,
) {
