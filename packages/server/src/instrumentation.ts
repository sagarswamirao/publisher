...
import { BatchLogRecordProcessor, ConsoleLogRecordExporter, LogRecordExporter } from '@opentelemetry/sdk-logs';
...
if (otelCollectorUrl) {
  console.log("Initializing OpenTelemetry SDK with OTLP collector at", otelCollectorUrl);
  ...
  logExporter = new OTLPLogExporter({
    ...
    console.log("No OTLP collector URL found, initializing console-based telemetry");
